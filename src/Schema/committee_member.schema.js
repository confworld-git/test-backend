...
const { Schema } = mongoose; // Destructure Schema here
...
const committeeMemberSchema = new Schema({ // Renamed 'committee_member' to 'committeeMemberSchema' for clarity
  Title: {
    type: String,
...
const CommitteeMember = mongoose.models.CommitteeMember || mongoose.model("CommitteeMember", committeeMemberSchema);
